...
class HomeFragment : Fragment() {
    ...
    private fun updateSessionControlView() {
        if (requireContext().components.appStore.state.mode == BrowsingMode.Private) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        PrivateBrowsingButtonView(binding.privateBrowsingButton, requireComponents.appStore) { newMode ->
